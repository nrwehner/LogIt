                    ...
                    .Select(
                        e =>
                            new FoodDayItemDetail
                            {
                                ...
                                CalorieWeight = Math.Round(((double)e.FoodItem.Calories / (double)e.FoodDay.UserProfile.CaloryTarget),2),
                                ItemCarbs = e.FoodItem.CarbohydrateGrams,
                                CarbTarget = e.FoodDay.UserProfile.CaloryTarget,
                                CarbWeight = Math.Round((e.FoodItem.CarbohydrateGrams / e.FoodDay.UserProfile.CarbTarget) / ((double)e.FoodItem.Calories / (double)e.FoodDay.UserProfile.CaloryTarget),2),
                                ItemFiber = e.FoodItem.FiberGrams,
                                FiberTarget = e.FoodDay.UserProfile.FiberTarget,
                                FiberWeight = Math.Round((e.FoodItem.FiberGrams / e.FoodDay.UserProfile.FiberTarget) / ((double)e.FoodItem.Calories / (double)e.FoodDay.UserProfile.CaloryTarget), 2),
                                ItemFat = e.FoodItem.FatGrams,
                                FatTarget = e.FoodDay.UserProfile.FatTarget,
                                FatWeight = Math.Round((e.FoodItem.FatGrams / e.FoodDay.UserProfile.FatTarget) / ((double)e.FoodItem.Calories / (double)e.FoodDay.UserProfile.CaloryTarget), 2),
                                ItemProtein = e.FoodItem.ProteinGrams,
                                ProteinTarget = e.FoodDay.UserProfile.ProteinTarget,
                                ProteinWeight = Math.Round((e.FoodItem.ProteinGrams / e.FoodDay.UserProfile.ProteinTarget) / ((double)e.FoodItem.Calories / (double)e.FoodDay.UserProfile.CaloryTarget), 2),
                                ItemSodium = e.FoodItem.SodiumMilligrams,
                                SodiumTarget = e.FoodDay.UserProfile.SodiumTarget,
                                SodiumWeight = Math.Round(((double)e.FoodItem.SodiumMilligrams / e.FoodDay.UserProfile.SodiumTarget) / ((double)e.FoodItem.Calories / (double)e.FoodDay.UserProfile.CaloryTarget), 2),
                                ItemPotassium = e.FoodItem.PotassiumMilligrams,
                                PotassiumTarget = e.FoodDay.UserProfile.PotassiumTarget,
                                PotassiumWeight = Math.Round(((double)e.FoodItem.PotassiumMilligrams / e.FoodDay.UserProfile.PotassiumTarget) / ((double)e.FoodItem.Calories / (double)e.FoodDay.UserProfile.CaloryTarget), 2),
                                CreatedBy = e.CreatedBy,
                                CreatedUtc = e.CreatedUtc,
